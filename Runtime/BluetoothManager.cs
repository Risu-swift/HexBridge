...
public class BluetoothManager : CommunicationManager
{
    ...
    {
        base.Init();
        Debug.Log("Bluetooth communication initialized");
    ...
    public override void StartConnection()
    {
        ...
        BluetoothConnector.CallStatic("StartConnection", deviceToConnect.ToUpper());
    }
    ...
    public override void WriteValue(byte[] dataToSend)
    {
        if (Application.platform != RuntimePlatform.Android)
            return;
